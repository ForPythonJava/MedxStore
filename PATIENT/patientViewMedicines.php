...
<?php
$a = "SELECT `medicine`.* FROM `medicine` WHERE `shopid`='$sid'";
                                ...
                                <div class="single-products sp-layout-two">
                                    ...
                                    <div class="product-content">
                                        ...
                                        if ($row['stock'] == 0) {
                                            ...
                                            ?>
                                            <a href="addToCartProcess.php?id=<?php echo $row['med_id'] ?>&amount=<?php echo $row['rate'] ?>&stock=<?php echo $row['stock'] ?>&sid=<?php echo $sid ?>"
                                                class="btn btn-cart">
