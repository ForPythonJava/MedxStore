          ...
          <nav class="navbar navbar-expand-lg main-menu">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav mr-xl-auto ml-lg-auto">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="patientRegister.php">Patient</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="shopRegister.php">Shop</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="deliveryRegister.php">Delivery Boy</a>
                </li>
              </ul>
            </div>
          </nav>
