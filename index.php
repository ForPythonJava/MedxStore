...
<!-- Mirrored from themelayer.net/html/MEDXSTORE/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Aug 2023 06:01:59 GMT -->

<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>MEDXSTORE</title>
          ...
          <nav class="navbar navbar-expand-lg main-menu">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav mr-xl-auto ml-lg-auto">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="./COMMON/login.php">Login</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="./COMMON/patientRegister.php">Patient</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="./COMMON/shopRegister.php">Shop</a>
                </li>
                ...
                <li class="nav-item">
                  <a class="nav-link" href="./COMMON/deliveryRegister.php">Delivery Boy</a>
                </li>
              </ul>
            </div>
          </nav>
      ...
      <div class="row">
        <div class="col-lg-3 col-md-12">
          <div class="category-list">
            ...
            <ul>
              <li><a href="shop.html"><i class="fas fa-long-arrow-alt-right"></i> Apparel & Protective Gear</a></li>
              ...
              <li><a href="shop.html"><i class="fas fa-long-arrow-alt-right"></i> Home Health Care</a></li>
              <li><a href="shop.html"><i class="fas fa-long-arrow-alt-right"></i> ncontinence</a></li>
              <li><a href="shop.html"><i class="fas fa-long-arrow-alt-right"></i> Ostomy & Urology</a></li>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="section-title">
            ...
            <p class="content mb-10">What customer say amazing products</p>
          </div>
          <div class="testimonial-slide owl-carousel">
            <div class="single-testimonial">
              <div class="testimonial-icon">
                <img src="assets/images/icon7.png" alt="img">
              </div>
              <div class="testimonial-info">
                <div class="testimonial-pic">
                  <img src="assets/images/test-pic1.png" alt="img">
                </div>
                <div class="testimonial-content">
                  <div class="testimonial-name">
                    <span>John M. Roy</span>
                  </div>
                  <p class="content">lorem sint ullamco ac lacus. nisi ut risus scelerisque aliquet, aliquip aliqua.
                    dolore pellentesque odio. pariatur. turpis id pariatur. culpa curabitur adipiscing lorem</p>
                </div>
              </div>
            </div>
            <div class="single-testimonial">
              ...
              <div class="testimonial-info">
                <div class="testimonial-pic">
                  <img src="assets/images/01_Home_1.png" alt="img">
                </div>
                <div class="testimonial-content">
                  <div class="testimonial-name">
                    <span>David S. Colwell</span>
                  </div>
                  <p class="content">lorem sint ullamco ac lacus. nisi ut risus scelerisque aliquet, aliquip aliqua.
                    dolore pellentesque odio. pariatur. turpis id pariatur. culpa curabitur adipiscing lorem</p>
                </div>
          ...
          <div class="owl-carousel blog-carousel owl-theme">
            <div class="item">
              <div class="single-blog">
                ...
                <div class="blog-info">
                  ...
                  <h4 class="title"><a href="blog-single.html"> Proof that Vitamin D is a key factor in beating
                      Covid-19</a></h4>
                </div>
              </div>
            </div>
            ...
            <div class="item">
              <div class="single-blog">
                ...
                <div class="blog-info">
                  <span class="date">February 20, 2020</span>
                  <h4 class="title"><a href="blog-single.html">How Vitamin C can protect against the risk of
                      coronavirus</a></h4>
                </div>
              </div>
            </div>
