...
<!-- Mirrored from themelayer.net/html/MEDXSTORE/contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Aug 2023 06:02:46 GMT -->
                            ...
                            <ul class="navbar-nav mr-xl-auto ml-lg-auto">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                        <a class="dropdown-item" href="adminViewShops.php">Shops</a>
                                        <div class="dropdown-divider"></div>
                                        <a class="dropdown-item" href="adminViewDeliveryBoys.php">Delivery Boys</a>
                                        <div class="dropdown-divider"></div>
                                        <a class="dropdown-item" href="adminViewOrders.php">Orders</a>
                                    </div>
                                </li>
                            </ul>
                        </div>
