...
<?php
$a = "SELECT `deliveryboy`.*,`login`.* FROM `deliveryboy`,`login` WHERE `deliveryboy`.`delivery_id`=`login`.`reg_id` AND `login`.`usertype`='Delivery Boy'";
                ...
                while ($row = mysqli_fetch_array($qry)) {
                    ...
                    <tr id="row{{ forloop.counter }}" style="text-align: center;">
                        ...
                        <?php if ($row['status'] == "Pending") {
                            ...
                            <td>
                                <div style="display: flex;justify-content: center;align-items: center;">
                                    <a href="manageBoys.php?id=<?php echo $row['email'] ?>&status=Approved"
                                        class="btn btn-outline-success">Approve</a>
                                    <a href="manageBoys.php?id=<?php echo $row['email'] ?>&status=Rejected"
                        ...
                        <?php } else { ?>
                            <td>
                                <div style="display: flex;justify-content: center;align-items: center;">
                                    <a href="manageBoys.php?id=<?php echo $row['email'] ?>&status=Delete"
